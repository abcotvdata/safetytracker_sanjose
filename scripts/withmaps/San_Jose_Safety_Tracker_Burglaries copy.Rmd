...
<subhead>A closer look at San Jose burglaries neighborhood by neighborhood</subhead>
...
san_jose_burglary_map <- leaflet(burglaries_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
san_jose_burglary_map
```
<br>
<br>
<!-- <subhead>Burglaries month by month, 2019 through last month</subhead> -->

<iframe title="Burglaries year by year in San Francisco (Copy)" aria-label="Column Chart" id="datawrapper-chart-2f6bd" src="https://datawrapper.dwcdn.net/2f6bd/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
  <br>
<br>
