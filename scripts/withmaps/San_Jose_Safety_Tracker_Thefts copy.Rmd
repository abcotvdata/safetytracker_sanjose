...
<subhead>San Jose thefts neighborhood by neighborhood</subhead>
...
san_jose_theft_map <- leaflet(thefts_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
