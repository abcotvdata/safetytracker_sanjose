...
The totals included here are for theft of a motor vehicle, and do not include thefts of parts of vehicles or thefts from vehicles.

<subhead>A closer look at San Jose vehicle thefts by neighborhood</subhead>

The risk is not the same neighborhood to neighborhood. ABC7's data team looked at the San Jose Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.

The map color codes each neighborhood by the vehicle theft rate over the last 12 months. The three darker blues represent neighborhoods with vehicle theft rates that are higher than the citywide rate. You can also click the box in the bottom right corner to see neighborhoods by the number of vehicles stolen.
...
san_jose_autotheft_map <- leaflet(autothefts_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
san_jose_autotheft_map
```
<br>
<br>
<!-- <subhead>Auto thefts year by year, 2019 through last month</subhead> -->

<iframe title="Vehicle thefts year by year in San Francisco" aria-label="Column Chart" id="datawrapper-chart-Uat0Y" src="https://datawrapper.dwcdn.net/Uat0Y/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
  <br>
<br>
